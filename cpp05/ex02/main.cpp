...
int		main(void)
{
	...
	try {
		...
		std::cout << "TEST (5): OK" << ": form signed " << testF.getForm() << std::endl;
	} catch (std::exception & e) {
	...
	try {
		...
		std::cout << "trying to sign" << std::endl;
		testB.signForm(&testF);
		std::cout << "TEST (6): OK" << ": form signed " << testF.getForm() << std::endl;
	} catch (std::exception & e) {
	...
	try {
		...
		std::cout << "trying to sign" << std::endl;
		testB.signForm(&testF);
		std::cout << "TEST (7): OK" << ": form signed " << testF.getForm() << std::endl;
	} catch (std::exception & e) {
